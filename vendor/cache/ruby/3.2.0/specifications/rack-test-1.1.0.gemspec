...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rack>.freeze, [">= 1.0".freeze, "< 3".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 12.0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.6".freeze])
  s.add_development_dependency(%q<sinatra>.freeze, [">= 1.0".freeze, "< 3".freeze])
  s.add_development_dependency(%q<rdoc>.freeze, ["~> 5.1".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, [">= 0.49".freeze, "< 0.50".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.16".freeze])
  s.add_development_dependency(%q<thor>.freeze, ["~> 0.19".freeze])
end
